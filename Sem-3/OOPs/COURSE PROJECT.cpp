...
class patient_info : protected helpline_team               
{
	...
	protected:                                                                                 
	    void display_info()                                                              
	    { 
		cout<<"\n\n ______________________________________________Log-in__________________________________________________ \n\n";                                                                               
	    call();                                                                          
		data_frm_ht();
		string input;
		int attempt = 0;
 ...
 \n lab Ayur Tests:- "<<A_total_patients;
	...
	private:                                                                                    
		...
		{    
		 ...
		 dbms.open("database.txt",ios_base::app);
			...
			cout<<"\n\n\n ____________________________________ Patient registration forum _____________________________________"; 
			cout<<"\n\n\n Enter your name: ";                      
		    cin.ignore(); 
		...
		while(i<200)
			...
			cin>>age;
			dbms<<" "<<age<<endl;                                  
			if ((age>=65 && age<=90) || (age>=97 && age<=122))  
			{
			throw 505;
			}
			else
		...
		{                                                                                
			...
			cout<<"\n\n\n\n ______________________________________Lab, Test in progress ________________________________________";                        
	...
	protected:                                                        
		...
		void sms()
		{
			...
			if (y == 'y' || y == 'Y')
			{
				cout<<"\n SMS: Reports delivered successfully to all positive patients";
			}
			else
			{
				cout<<"\n Sms is not sent yet";
...
{                                          
	...
	protected:  
	 int kit;                    
		...
		{		                  
			...
			chem_list.insert(pair<string , string>("g","Gerwapectin (100 mL)"));
			...
			cout<<"\n\n\n ______________________________________ Chemicals in lab _____________________________________________";                          
		do
		{	
	...
	void operator --()
	{
		...
		display_info();
		test_kit();
		cout<<"\n\n\n ______________________________________ SMS Update ____________________________________________________";
		sms();
		string input2;
		int attempt2;
		cout<<"\n\n\n ____________________________________ Weekly Report of lab ____________________________________________"; 
		while(attempt2<5)
		{
